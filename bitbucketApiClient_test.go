...
func TestSetBuildStatus(t *testing.T) {
	...
	t.Run("Succeeded", func(t *testing.T) {
		...
		err := bitbucketAPIClient.SetBuildStatus("KgSCeb8aZpHrUhDAVk5p8D8PA_08MbBpE3SNzFLSaTSd7uflrgOtelObPD6BRpd_AcdrvIvbu23xcWPfuws=", "xivart/inrule-catalogs-live", "3993d790d0a19fc5da450d61dc4de6473be1c440", "succeeded")
